...
if not os.path.exists('../input'):
    get_ipython().system('kaggle competitions download -c ultrasound-nerve-segmentation -wp nerve')
    get_ipython().system('mkdir ../input')
    get_ipython().system('mv nerve/ultrasound-nerve-segmentation/* ../input')
    get_ipython().system('cd ../input; ls *.zip|awk -F\'.zip\' \'{print "unzip "$0" -d "$1}\'|sh > null')
