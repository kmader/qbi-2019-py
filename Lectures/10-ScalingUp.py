...
display(pd.DataFrame(dict(id=(1, 2, 3), Weight=(100, 40, 80))))
...
def line_to_words(in_line):
    ...
    v_words = [
        "".join([c for c in c_word if c in string.ascii_lowercase]) for c_word in words
    ]
...
da_foam = da.from_array(foam_stack / 255.0, chunks=(20, 400, 400), name="FoamImage")
